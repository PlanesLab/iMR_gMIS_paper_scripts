function [G, G_ind, G_rxns, related, n_genes_KO, G_time, iMRmodel_info] = buildGmatrix_iMRmodel_gMCS(model_name, model_struct, regulatoryNetwork, nLayers, pos, numWorkers)
...
% USAGE:
%
%    [G, G_ind, G_rxns, related, n_genes_KO, G_time, iMRmodel_info] = buildGmatrix_iMRmodel_gMCS(model_name, model_struct, regulatoryNetwork, nLayers, pos, numWorkers)
%
% INPUTS:
...
% EXAMPLE:
%
%    [G, G_ind, G_rxns, related, n_genes_KO, G_time, iMRmodel_info] = buildGmatrix_iMRmodel_gMCS(Human1_TRRUST1, HumanGEM, TRRUST_interactions, 1, 10, 8)
%
% .. Authors:
